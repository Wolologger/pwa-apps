...
- **Tests** — `tests/nav-ptr.test.js` (14 tests: PTR solo activa en condiciones correctas) y `tests/add-flow.test.js` (23 tests: persistencia inmediata, IDs activos tras sync, sync guard, sin ventanas de pérdida de datos). Total acumulado: **406 tests**.
